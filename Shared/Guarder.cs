...
// This main part of this class comes from imagetoolswinrt project
// links to: http://imagetoolswinrt.codeplex.com
...
namespace Renren.Components.Tools
{
    ...
    public static class Guarder
    {
        ...
        public static void InjectTogether(object target1, object target2, string parameterName)
        {
            if ((target1 != null && target2 == null) && (target2 != null && target1 == null))
            {
                throw new ArgumentNullException(parameterName);
            }
        }
        ...
        /// <summary>
        /// Verifies, that the method parameter with specified two object value and message  
        /// is not null and throws an exception if the object is null.
        /// </summary>
        /// <param name="target1">The target object, which cannot be null.</param>
        /// <param name="target2">The target object, which cannot be null.</param>
        /// <param name="parameterName">Name of the parameter.</param>
        /// <exception cref="ArgumentNullException"><paramref name="target"/> is
        /// null (Nothing in Visual Basic).</exception>
        public static void AtLeastOneNotNull(object target1, object target2, string parameterName)
        {
