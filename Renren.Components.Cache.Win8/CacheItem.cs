...
namespace Renren.Components.Caching
{
    ...
    public class CacheItem
    {
        ...
        public readonly AsyncLock ItemLock = new AsyncLock();
        /// <summary>
        ...
        public CacheItem(string key,CacheItemPriority scavengingPriority, ICacheItemRefreshAction refreshAction, params ICacheItemExpiration[] expirations)
        {
            Initialize(key,refreshAction, scavengingPriority, expirations);
        ...
        /// <param name="refreshAction">Object supplied by caller that will be invoked upon expiration of the CacheItem. May be null.</param>
        /// <param name="expirations">Param array of ICacheItemExpiration objects. May provide 0 or more of these.</param>
        public CacheItem(DateTime lastAccessedTime, string key, CacheItemPriority scavengingPriority, ICacheItemRefreshAction refreshAction, params ICacheItemExpiration[] expirations)
        {
            Initialize(key,refreshAction, scavengingPriority, expirations);
        ...
        internal void Replace(ICacheItemRefreshAction cacheItemRefreshAction, CacheItemPriority cacheItemPriority, params ICacheItemExpiration[] cacheItemExpirations)
        {
            Initialize(this.key,cacheItemRefreshAction, cacheItemPriority, cacheItemExpirations);
            TouchedByUserAction(false);
        }
        ...
        private void Initialize(string cacheItemKey,ICacheItemRefreshAction cacheItemRefreshAction, CacheItemPriority cacheItemPriority, ICacheItemExpiration[] cacheItemExpirations)
        {
            key = cacheItemKey;
            refreshAction = cacheItemRefreshAction;
            scavengingPriority = cacheItemPriority;
            if (cacheItemRefreshAction == null)
                refreshAction = new DefaultRefreshAction();
            if (cacheItemExpirations == null || cacheItemExpirations.Length == 0)
            {
