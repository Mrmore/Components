...
namespace Renren.Components.Caching
{
    ...
    public interface ICacheItemRefreshAction
    {
        ...
        /// out of it.</remarks>
        void Refresh(string removedKey, CacheItemRemovedReason removalReason);
    }

    public class DefaultRefreshAction : ICacheItemRefreshAction
    {
        public void Refresh(string removedKey, CacheItemRemovedReason removalReason)
        {
            //Debug.WriteLine(removedKey + " removed " + " because of " + removalReason.ToString());
        }
    }
}
