...
namespace ImageTools.Controls
{
    ...
    /// 	</para>
    /// </remarks>
    [TemplatePart(Name = AnimatedImage.ImagePart, Type = typeof(Windows.UI.Xaml.Controls.Image))]
    public class AnimatedImage : Control
    {
        ...
        public static readonly DependencyProperty FilterProperty =
            DependencyProperty.Register("Filter", typeof(IImageFilter), typeof(AnimatedImage), new PropertyMetadata(null, OnFilterPropertyChanged));
        /// <summary>
        ...
        private async Task LoadImage(ExtendedImage image)
        {
