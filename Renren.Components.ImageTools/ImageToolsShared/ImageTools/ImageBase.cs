...
namespace ImageTools
{
    ...
    public partial class ImageBase
    {
        ...
        private volatile bool _needRaster = false;
        public bool NeedRaster { get { return _needRaster; } set { _needRaster = value; } }
        private BitmapPixelFormat _pixelFormat;
        ...
        private BitmapAlphaMode _alphaMode;
        public BitmapAlphaMode AlphaMode
        {
            get
            {
                // Contract.Ensures(!IsFilled || // Contract.Result<int>() > 0);
        ...
        public void SetPixels(int width, int height, byte[] pixels, BitmapPixelFormat format, BitmapAlphaMode alpha)
        {
            #if !NETFX_CORE
            // Contract.Requires<ArgumentException>(width >= 0, "Width must be greater than zero.");
            // Contract.Requires<ArgumentException>(height >= 0, "Height must be greater than zero.");
