            ...
            await Task.Run(async () =>
                {
                    ...
                    //    ImageFrame image_frame = new ImageFrame();
                    //    var privder = await frame.GetPixelDataAsync();
                    //    var pixelsData = privder.DetachPixelData();
                    //    image_frame.SetPixels((int)frame.PixelWidth, (int)frame.PixelHeight, pixelsData);

                    //    _image.Frames.Add(image_frame);
                    //}
