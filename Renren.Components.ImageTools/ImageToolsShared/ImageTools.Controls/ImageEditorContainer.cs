...
namespace ImageTools.Controls
{
    ...
    public class ImageEditorContainer : Control
    {
        ...
        public static readonly DependencyProperty SelectionProperty =
            DependencyProperty.Register("Selection", typeof(Rect), typeof(ImageEditorContainer), new PropertyMetadata(null, OnSelectionChanged));
        /// <summary>
        ...
        public static readonly DependencyProperty SourceProperty =
            DependencyProperty.Register("Source", typeof(ExtendedImage), typeof(ImageEditorContainer), new PropertyMetadata(null, OnSourceChanged));
        /// <summary>
        ...
        {
#if NETFX_CORE
            Dispatcher.RunAsync(Windows.UI.Core.CoreDispatcherPriority.Normal, () => OnSourceChanged());
#else
    ...
    DependencyProperty.Register("Scaling", typeof(double), typeof(ImageEditorContainer), new PropertyMetadata(null, OnScalingChanged));
#else
        public static readonly DependencyProperty ScalingProperty =
        ...
        /// call <see cref="M:Windows.UI.XMAL.ApplyTemplate"/>.
        /// </summary>
        ...
        private void BindXamlElements()
        {
            ...
            {
                _selectionArea.PointerPressed += new PointerEventHandler(selectionArea_PointerPressed);
                _selectionArea.PointerCaptureLost += new PointerEventHandler(selectionArea_PointerCaptureLost);
                _selectionArea.PointerMoved += new PointerEventHandler(selectionArea_PointerMoved);
            }
            ...
            {
                _selectionBorder.PointerPressed += new PointerEventHandler(selectionBorder_PointerPressed);
                _selectionBorder.PointerCaptureLost += new PointerEventHandler(selectionBorder_PointerCaptureLost);
                _selectionBorder.PointerMoved += new PointerEventHandler(selectionBorder_PointerMoved);
            }
        ...
        private void selectionBorder_PointerPressed(object sender, PointerRoutedEventArgs re)
        {
            if (re.Pointer.PointerDeviceType == Windows.Devices.Input.PointerDeviceType.Mouse)
            {
                if (re.GetCurrentPoint(null).Properties.IsLeftButtonPressed)
                {
                    if (MoveSelection)
                    {
                        _lastMousePosition = re.GetCurrentPoint(null).Position;

                        _isMoving = true;

                        if (_selectionBorder != null)
                        {
                            _selectionBorder.CapturePointer(re.Pointer);
                        }
        ...
        private void selectionBorder_PointerCaptureLost(object sender, PointerRoutedEventArgs e)
        {
            if (_isMoving)
            {
                _isMoving = false;
        ...
        private void selectionArea_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
            if (e.Pointer.PointerDeviceType == Windows.Devices.Input.PointerDeviceType.Mouse)
            {
                if (e.GetCurrentPoint(null).Properties.IsLeftButtonPressed)
                {
                    if (!MoveSelection)
                    {
                        _lastMousePosition = e.GetCurrentPoint(_imageElement).Position;
                        ...
                        else
                        {
                            ...
                            if (_selectionArea != null)
                            {
                                _selectionArea.CapturePointer(e.Pointer);
                            }
                        }
        ...
        private void selectionArea_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            if (_selectionArea != null)
            {
                if (_isSelecting)
                {
                    Point mousePosition = e.GetCurrentPoint(_imageElement).Position;
        ...
        private void selectionArea_PointerCaptureLost(object sender, PointerRoutedEventArgs e)
        {
            if (_isSelecting)
            {
                _isSelecting = false;
                ...
                if (_selectionArea != null)
                {
                    _selectionArea.ReleasePointerCapture(e.Pointer);
                }
            }
        }
